...
Versão 2.0 – Preenchimento por regressão linear entre estações do mesmo tipo
Autor: [Seu nome]
Data: 2025-05-19
"""
...
CONFIG = {
    ...
    "end_date": "2024-01-31",
    "min_common_pairs": 30,           # mínimo de pares completos para a regressão
          ...
          for idx in df.index[missing_mask]:
              ...
              for pred in ordered_preds:
                  ...
                  if pd.notna(pred_val):
                      ...
                      # Truncar em zero para variáveis hidrológicas não negativas
